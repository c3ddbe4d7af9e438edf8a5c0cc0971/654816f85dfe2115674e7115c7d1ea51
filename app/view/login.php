        ...
        <div class="login_form">
          ...
          <form action="/login" method="POST">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="text" value="13203074" placeholder="Roll Number" name="reference_id" style="background:white; color:black;">
      
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Password:</label>
              <input type="password" class="form-control" id="password" value="24835769" placeholder="Password" name="password" style="background:white; color:black;">
